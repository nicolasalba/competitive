/*
Given and a pattern and a string returns
the position of matches with wildcard in both.

Also this code returns the number of different strings;
2 6
?L
??GHLL
...
int main() {
  ...
  // print the number of different matchs
  // cout << v.size() << endl;
